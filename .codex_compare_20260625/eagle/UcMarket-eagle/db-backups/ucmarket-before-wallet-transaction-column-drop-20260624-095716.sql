...
\restrict dq3lKxZMLNhBBTWCOGo2B0Lfu60Wck75R2D22r9V6UhmOHJJwDIHxHA0I90LcO6
...
CREATE VIEW public.v_ranking_profit AS
 WITH payouts AS (
         SELECT wallet_transactions.user_id,
            sum(wallet_transactions.amount) AS total_payout
           FROM public.wallet_transactions
          WHERE ((wallet_transactions.type)::text = 'RESOLUTION_PAYOUT'::text)
...
COPY public.wallet_transactions (id, wallet_id, type, amount, balance_after, reference_type, reference_id, idempotency_key, created_at, user_id, market_id, metadata) FROM stdin;
\.
...
--
-- Name: idx_wallet_transactions_market_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wallet_transactions_market_id ON public.wallet_transactions USING btree (market_id);
...
--
-- Name: wallet_transactions fk_wallet_transactions_market; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wallet_transactions
    ADD CONSTRAINT fk_wallet_transactions_market FOREIGN KEY (market_id) REFERENCES public.markets(id);


--
-- Name: wallet_transactions fk_wallet_transactions_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wallet_transactions
    ADD CONSTRAINT fk_wallet_transactions_user FOREIGN KEY (user_id) REFERENCES public.users(id);
...
\unrestrict dq3lKxZMLNhBBTWCOGo2B0Lfu60Wck75R2D22r9V6UhmOHJJwDIHxHA0I90LcO6
