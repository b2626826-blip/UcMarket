...
- **狀態**：workflow JSON、隔離 fixture、兩組 credential 綁定與 n8n `2.29.11` fresh session runtime 驗收均已完成（無 findings）；預設 `active: false`，目前維持 inactive，確認指定的唯一 `07` instance 與部署時機後再由維運者 Activate。
