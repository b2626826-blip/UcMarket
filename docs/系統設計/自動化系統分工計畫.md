...
- `N8nWebhookEmailSender`、規則式預審第一切片、FAILED 告警與時事蒐證均已完成；目前維護入口改看《自動化系統規劃》與《n8n 整合規劃》。
...
- 整合分支全部合完後，由沒寫 core 的人（三人版為丙）跑最終驗收：
  ...
  2. 當時的 migration 雙驗證為空資料庫跑 V1→V6、既有 V5 升級到 V6；現行版本已到 V13，後續 migration 必須驗證全新資料庫與上一版本升級。
